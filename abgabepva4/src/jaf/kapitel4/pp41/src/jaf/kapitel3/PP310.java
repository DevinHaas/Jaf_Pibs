...
public class PP310 extends Application{
  public void start(Stage primaryStage){
    ...
    Circle head = new Circle(80, 70, 80);
    head.setFill(Color.WHITE);

    Circle rightEye = new Circle(80, 70, 30);
    ...
    Group snowman = new Group(base, middle, head, leftEye, rightEye, mouth, topButton, bottomButton,
        leftArm, rightArm, hat);
